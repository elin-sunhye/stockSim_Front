        ...
        return tableType === 'vertical' ? (
                        ...
                        data.map((tbody: T, trIndex: number) => {
                            return (
                                <tr
                                    key={`tbody_${trIndex}`}
                                    className={`${
                                        trHover && trHover === true
                                            ? style.hover
                                            : ''
                                    }`}
                                >
                                    {headers.map(
                                        (thead: TableHeader, tdIndex) => {
                                            switch (thead.form) {
                                                case 'check':
                                                    return (
                                                        <td
            ...
            <table className={style.tb_st2} ref={ref}>
                <colgroup>
                    <col
                        width={
                            headers.length > 0 && headers[0].width
                                ? headers[0].width
                                : 'auto'
                        }
                    />
                    <col
                        width={
                            headers.length > 0 && headers[1].width
                                ? headers[1].width
                                : 'auto'
                        }
                    />
